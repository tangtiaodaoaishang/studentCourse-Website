 ...
 * @description: 测试支付宝扫码支付接口
 * @author: ldjc
 * @create: 2024-02-13 23:05
 **/
@Controller
...
//        alipayRequest.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
        ...
        alipayRequest.setBizContent("{" +
                "    \"out_trade_no\":\"202210102010102012\"," +  //out_trade_no为订单号与课程id有关(该值是唯一的,即判断支付结果是否重复,如果重复则提示订单重复无法支付)
                "    \"total_amount\":10," +  //total_amount为支付价格
                "    \"subject\":\"Iphone6 16G\"," + //subject为支付手机型号
    ...
    //接收通知(仅供参考,因为没有自己的域名无法展示结果 -- alipayRequest.setNotifyUrl("http://tjxt-user-t.itheima.net/xuecheng/orders/paynotify"))
