...
<#--每一个由后台freemark传入的属性最好最后都加上!'',作用是如果传入的属性为空则赋空字符串值,预防传入的属性为空报错,无法显示前端页面-->
<#--??用于特殊语句的属性判空,比如if条件语句等-->
<head>
    <meta charset="utf-8">
...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="pic">
                <#if model.courseBase.charge?? && model.courseBase.charge=='201001'>
                            ...
                            <div class="item">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        ...
                                        <#--这里注意如果发布的课程的二级目录没有添加视频,则secondNode.teachplanMedia.teachplanId值为null,则该ftl文件就会报错-->
                                            <li><a href="http://www.51xuecheng.cn:82/course/preview/learning.html?id=${model.courseBase.id}&chapter=${secondNode.teachplanMedia.teachplanId!''}" target="_blank">${secondNode.pname}</a></li>
                                        </#list>
                                    </ul>
                                </div>
                            </div>
